...
- The protocol specifies Adam `1e-4`, weight decay `0`, batch `6`, 20 RSNA epochs only for confidence fitting ([protocol](/home/tianqini/research/.ivr-p5-worktrees/p5a-resources/docs/research/view_risk_protocol.md:334)).
- `ResearchRunConfig` enforces those values globally, and production fresh-classifier fitting reuses them ([training.py](/home/tianqini/research/.ivr-p5-worktrees/p5a-resources/src/mmdc_clip_f/research/view_risk/training.py:138), [production.py](/home/tianqini/research/.ivr-p5-worktrees/p5a-resources/src/mmdc_clip_f/research/view_risk/production.py:1393)).
- Legacy RSNA ViT-B/32 classifier fitting is materially different: Adam `1e-7`, weight decay `1e-5`, batch `3`, 50 epochs ([legacy config](/home/tianqini/research/.ivr-p5-worktrees/p5a-resources/configs/stage1/rsna_vit_b_32_legacy.yaml:29)).
...
- [Diagnostic script](/home/tianqini/research/.ivr-p5-worktrees/p5a-resources/scripts/research/p5a_resource_probe.py)
- [Sanitized aggregate evidence](/home/tianqini/research/.ivr-p5-worktrees/p5a-resources/evidence/phase5/p5a-resources.json)
